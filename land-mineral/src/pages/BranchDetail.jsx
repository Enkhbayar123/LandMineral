...
const BranchDetail = () => {
  ...
  // Find the branch data based on the URL parameter
  ...
  // Get the translated list of features/highlights
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-6">
            <div className="bg-slate-900 p-6 rounded-xl border border-slate-800">
              ...
              {/* Website Button (Internal vs External Logic) */}
              <div className="mt-8 pt-8 border-t border-slate-800">
                {branch.details?.website?.startsWith('/') ? (
                  // Internal Link (Use React Router Link)
                  <Link 
                    to={branch.details.website}
